'use client'
import AddLoanForm from '@/components/(keuangan)/pinjaman/form-tambah-pinjaman/page'
import AddLoan from '@/components/(keuangan)/pinjaman/tabel-tambah-pinjaman/page'
