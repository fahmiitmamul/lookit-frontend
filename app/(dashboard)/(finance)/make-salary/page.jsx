'use client'
import MainSalaryForm from '@/components/(keuangan)/buat-gaji/form-tambah-gaji/page'
import MainSalaryTable from '@/components/(keuangan)/buat-gaji/tabel-gaji-pokok/page'
...
import AdditionalSalaryTable from '@/components/(keuangan)/buat-gaji/tabel-tambahan/page'
import SalaryCutsTable from '@/components/(keuangan)/buat-gaji/tabel-potongan/page'
import BpjsTable from '@/components/(keuangan)/buat-gaji/tabel-bpjs/page'
import InsuranceTable from '@/components/(keuangan)/buat-gaji/tabel-asuransi/page'
import TaxTable from '@/components/(keuangan)/buat-gaji/tabel-pajak/page'
import { useDispatch, useSelector } from 'react-redux'
import {
    setInitialState,
    setSelectedMasterGaji,
} from '@/components/(keuangan)/store'
import { DetailMainSalary } from '@/components/(keuangan)/buat-gaji/form-detail-gaji-pokok/page'
import { useForm } from 'react-hook-form'
import { EditMainSalaryModal } from '@/components/(keuangan)/buat-gaji/form-edit-gaji-pokok/page'
import Select from '@/components/ui/Select'
import MasterSalaryTambahanTable from '@/components/(keuangan)/buat-gaji/tabel-master-gaji-tambahan/page'
import MasterSalaryPotonganTable from '@/components/(keuangan)/buat-gaji/tabel-master-gaji-potongan/page'
import MasterGajiTambahanForm from '@/components/(keuangan)/buat-gaji/form-tambah-master-gaji-tambahan/page'
import MasterGajiPotonganForm from '@/components/(keuangan)/buat-gaji/form-tambah-master-gaji-potongan/page'
import DetailMasterGajiTambahanForm from '@/components/(keuangan)/buat-gaji/form-detail-master-gaji-tambahan/page'
import DetailMasterGajiPotonganForm from '@/components/(keuangan)/buat-gaji/form-detail-master-gaji-potongan/page'
import EditMasterGajiTambahanForm from '@/components/(keuangan)/buat-gaji/form-edit-master-gaji-tambahan/page'
import EditMasterGajiPotonganForm from '@/components/(keuangan)/buat-gaji/form-edit-master-gaji-potongan/page'
import HapusMasterGajiTambahanForm from '@/components/(keuangan)/buat-gaji/form-hapus-master-gaji-tambahan/page'
import HapusMasterGajiPotonganForm from '@/components/(keuangan)/buat-gaji/form-hapus-master-gaji-potongan/page'
import DeleteMainSalaryForm from '@/components/(keuangan)/buat-gaji/form-hapus-gaji-pokok/page'
import { DetailAdditionalSalaryModal } from '@/components/(keuangan)/buat-gaji/form-detail-tambahan/page'
import { EditAdditionalSalaryModal } from '@/components/(keuangan)/buat-gaji/form-edit-tambahan/page'
import DeleteTambahanForm from '@/components/(keuangan)/buat-gaji/form-hapus-tambahan/page'
import { DetailSalaryCutsModal } from '@/components/(keuangan)/buat-gaji/form-detail-potongan/page'
import { EditSalaryCutsForm } from '@/components/(keuangan)/buat-gaji/form-edit-potongan/page'
import DeleteSalaryCutsForm from '@/components/(keuangan)/buat-gaji/form-hapus-potongan/page'
import { EditBPJSModal } from '@/components/(keuangan)/buat-gaji/form-edit-bpjs/page'
import DeleteBpjsForm from '@/components/(keuangan)/buat-gaji/form-hapus-bpjs/page'
import { DetailInsuranceModal } from '@/components/(keuangan)/buat-gaji/form-detail-asuransi/page'
import { EditInsuranceModal } from '@/components/(keuangan)/buat-gaji/form-edit-asuransi/page'
import DeleteInsuranceForm from '@/components/(keuangan)/buat-gaji/form-hapus-asuransi/page'
import { DetailTaxForm } from '@/components/(keuangan)/buat-gaji/form-detail-pajak/page'
import { EditTaxForm } from '@/components/(keuangan)/buat-gaji/form-edit-pajak/page'
import DeleteTaxForm from '@/components/(keuangan)/buat-gaji/form-hapus-pajak/page'
import { DetailBpjsModal } from '@/components/(keuangan)/buat-gaji/form-detail-bpjs/page'
