'use client'
import MainSalaryForm from '@/components/(finance)/make-salary/add-main-salary-form/page'
import MainSalaryTable from '@/components/(finance)/make-salary/main-salary-table/page'
...
import AdditionalSalaryTable from '@/components/(finance)/make-salary/main-salary-addition-form/page'
import SalaryCutsTable from '@/components/(finance)/make-salary/main-salary-deduction-table/page'
import BpjsTable from '@/components/(finance)/make-salary/bpjs-table/page'
import InsuranceTable from '@/components/(finance)/make-salary/insurance-table/page'
import TaxTable from '@/components/(finance)/make-salary/tax-table/page'
import { useDispatch, useSelector } from 'react-redux'
import {
    setInitialState,
    setSelectedMasterGaji,
} from '@/components/(finance)/store'
import { DetailMainSalary } from '@/components/(finance)/make-salary/main-salary-detail-form/page'
import { useForm } from 'react-hook-form'
import { EditMainSalaryModal } from '@/components/(finance)/make-salary/edit-main-salary-form/page'
import Select from '@/components/ui/Select'
import MasterSalaryTambahanTable from '@/components/(finance)/make-salary/master-salary-addition-table/page'
import MasterSalaryPotonganTable from '@/components/(finance)/make-salary/master-salary-deduction-table/page'
import MasterGajiTambahanForm from '@/components/(finance)/make-salary/add-main-salary-addition-form/page'
import MasterGajiPotonganForm from '@/components/(finance)/make-salary/add-main-salary-deduction-form/page'
import DetailMasterGajiTambahanForm from '@/components/(finance)/make-salary/detail-master-salary-addition-form/page'
import DetailMasterGajiPotonganForm from '@/components/(finance)/make-salary/detail-master-salary-deduction-form/page'
import EditMasterGajiTambahanForm from '@/components/(finance)/make-salary/edit-master-salary-addition-form/page'
import EditMasterGajiPotonganForm from '@/components/(finance)/make-salary/edit-master-salary-deduction-form/page'
import HapusMasterGajiTambahanForm from '@/components/(finance)/make-salary/delete-main-salary-addition-form/page'
import HapusMasterGajiPotonganForm from '@/components/(finance)/make-salary/delete-main-salary-deduction-form/page'
import DeleteMainSalaryForm from '@/components/(finance)/make-salary/delete-main-salary-form/page'
import { DetailAdditionalSalaryModal } from '@/components/(finance)/make-salary/detail-addition-form/page'
import { EditAdditionalSalaryModal } from '@/components/(finance)/make-salary/edit-addition-form/page'
import DeleteTambahanForm from '@/components/(finance)/make-salary/delete-addition-form/page'
import { DetailSalaryCutsModal } from '@/components/(finance)/make-salary/detail-deduction-form/page'
import { EditSalaryCutsForm } from '@/components/(finance)/make-salary/edit-deduction-form/page'
import DeleteSalaryCutsForm from '@/components/(finance)/make-salary/delete-deduction-form/page'
import { EditBPJSModal } from '@/components/(finance)/make-salary/edit-bpjs-form/page'
import DeleteBpjsForm from '@/components/(finance)/make-salary/delete-bpjs-form/page'
import { DetailInsuranceModal } from '@/components/(finance)/make-salary/insurance-detail-form/page'
import { EditInsuranceModal } from '@/components/(finance)/make-salary/edit-insurance-form/page'
import DeleteInsuranceForm from '@/components/(finance)/make-salary/delete-insurance-form/page'
import { DetailTaxForm } from '@/components/(finance)/make-salary/detail-tax-form/page'
import { EditTaxForm } from '@/components/(finance)/make-salary/edit-tax-form/page'
import DeleteTaxForm from '@/components/(finance)/make-salary/delete-tax-form/page'
import { DetailBpjsModal } from '@/components/(finance)/make-salary/bpjs-detail-form/page'
