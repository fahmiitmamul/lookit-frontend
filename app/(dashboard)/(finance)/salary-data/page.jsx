'use client'
import SalaryCount from '@/components/(finance)/salary-count/tabel-hitung-gaji/page'
import TotalSalaryForm from '@/components/(finance)/salary-count/tambah-hitung-gaji/page'
import SalaryCountForm from '@/components/(finance)/salary-count/tambah-hitung-gaji/page'
