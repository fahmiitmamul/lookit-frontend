...
import ActiveEmployeeTable from '@/components/(employee)/employee-data/tabel-karyawan-aktif/page'
import NonActiveEmployeeTable from '@/components/(employee)/employee-data/tabel-karyawan-nonaktif/page'
...
import AddEmployeeForm from '@/components/(employee)/employee-data/form-tambah-karyawan/page'
import EditEmployeeForm from '@/components/(employee)/employee-data/form-edit-karyawan/page'
import DetailEmployeeForm from '@/components/(employee)/employee-data/form-detail-karyawan/page'
import DeleteEmployeeForm from '@/components/(employee)/employee-data/form-hapus-karyawan/page'
import { PDFDownloadLink } from '@react-pdf/renderer'
import { useDispatch, useSelector } from 'react-redux'
import MyDocument from '@/components/(employee)/employee-data/download-pdf-employee/page'
import { setSelectedData } from '@/components/(employee)/store'
import ExportToExcel from '@/components/(employee)/employee-data/export-excel-employee/page'
import ImportEmployeeForm from '@/components/(employee)/employee-data/form-import-karyawan/page'
