...
import ProcessedContractDataTable from '@/components/contract/processed-contract-data-table/page'
import UnfinishedContractTable from '@/components/contract/unfinished-contract-data-table/page'
import FinishedContractTable from '@/components/contract/approved-contract-table/page'
import DetailProcessedContractForm from '@/components/contract/detail-processed-contract-form/page'
import DeleteContractForm from '@/components/contract/delete-processed-contract-form/page'
import StatusFinishedContractForm from '@/components/contract/finished-contract-status-form/page'
import DeleteFinishedContractForm from '@/components/contract/delete-finished-contract-form/page'
import DetailFinishedContractForm from '@/components/contract/detail-finished-contract-form/page'
import StatusProcessedContractForm from '@/components/contract/processed-contract-status-form/page'
import AddProcessedContractForm from '@/components/contract/add-processed-contract-form/page'
import DeleteUnfinishedContractForm from '@/components/contract/delete-unfinished-contract-form/page'
import DetailUnfinishedContractForm from '@/components/contract/detail-unfinished-contract-form/page'
import StatusUnfinishedContractForm from '@/components/contract/unfinished-contract-status-form/page'
import AllContractTable from '@/components/contract/all-contract-data-table/page'
import DetailAllContractForm from '@/components/contract/detail-all-contract-form/page'
import StatusAllContractForm from '@/components/contract/all-contract-status-form/page'
import DeleteAllContractForm from '@/components/contract/delete-all-contract-form/page'
