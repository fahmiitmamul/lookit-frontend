...
import MakeAssetsTable from '@/components/assets/tabel-buat-aset/page'
import IncomingAssets from '@/components/assets/tabel-aset-masuk/page'
import OutgoingAssetsTable from '@/components/assets/tabel-aset-keluar/page'
import AddAssetsForm from '@/components/assets/form-tambah-buat-aset/page'
import EditMakeAssetsForm from '@/components/assets/form-edit-buat-aset/page'
import DetailMakeAssetsForm from '@/components/assets/form-detail-buat-aset/page'
import DeleteMakeAssetsForm from '@/components/assets/form-hapus-buat-aset/page'
import AddIncomingAssetsForm from '@/components/assets/form-tambah-aset-masuk/page'
import EditIncomingAssetsForm from '@/components/assets/form-edit-aset-masuk/page'
import DetailIncomingAssetsForm from '@/components/assets/form-detail-aset-masuk/page'
import DeleteIncomingAssetsForm from '@/components/assets/form-hapus-aset-masuk/page'
import AddOutgoingAssetsForm from '@/components/assets/form-tambah-aset-keluar/page'
import EditOutgoingAssetsForm from '@/components/assets/form-edit-aset-keluar/page'
import DetailOutgoingAssetsForm from '@/components/assets/form-detail-aset-keluar/page'
import DeleteOutgoingAssetForm from '@/components/assets/form-hapus-aset-keluar/page'
import Dropdown from '@/components/ui/Dropdown'
import { useSelector } from 'react-redux'
import { PDFDownloadLink } from '@react-pdf/renderer'
import AssetsDocument from '@/components/assets/download-pdf-aset/page'
import IncomingAssetsDocument from '@/components/assets/download-pdf-aset-masuk/page'
import OutgoingAssetsDocument from '@/components/assets/download-pdf-aset-keluar/page'
import ExportToExcelAssets from '@/components/assets/template-aset/page'
import ImportAssetsForm from '@/components/assets/import-aset/page'
