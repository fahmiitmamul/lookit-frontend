...
import DetailProcessedTaskForm from '@/components/tasks/detail-processed-tasks-form/page'
...
import EditAllTasksForm from '@/components/tasks/edit-all-tasks-form/page'
import DetailAllTasksForm from '@/components/tasks/all-tasks-detail-form/page'
import DeleteAllTasksForm from '@/components/tasks/delete-all-tasks-form/page'
