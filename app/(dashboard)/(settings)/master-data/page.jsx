...
import LeaveTypeTable from '@/components/(settings)/master-data/leave-type/leave-type-table/page'
import NationalHoliday from '@/components/(settings)/master-data/national-holiday/national-holiday-table/page'
import PermissionTable from '@/components/(settings)/master-data/permission-type/permission-type-table/page'
import AddLeaveTypeForm from '@/components/(settings)/master-data/leave-type/add-leave-type-form/page'
import EditLeaveTypeForm from '@/components/(settings)/master-data/leave-type/edit-leave-type-form/page'
import DetailLeaveTypeForm from '@/components/(settings)/master-data/leave-type/detail-leave-type-form/page'
import DeleteLeaveTypeForm from '@/components/(settings)/master-data/leave-type/delete-leave-type-form/page'
import AddPermissionTypeForm from '@/components/(settings)/master-data/permission-type/add-permission-type-form/page'
import EditPermissionTypeForm from '@/components/(settings)/master-data/permission-type/edit-permission-type-form/page'
import DetailPermissionTypeForm from '@/components/(settings)/master-data/permission-type/detail-permission-type-form/page'
import DeletePermissionTypeForm from '@/components/(settings)/master-data/permission-type/delete-permission-type-form/page'
import AddNationalHolidayForm from '@/components/(settings)/master-data/national-holiday/add-national-holiday-form/page'
import EditNationalHolidayForm from '@/components/(settings)/master-data/national-holiday/edit-national-holiday-form/page'
import DetailNationalHolidayForm from '@/components/(settings)/master-data/national-holiday/detail-national-holiday-form/page'
import DeleteNationalHolidayForm from '@/components/(settings)/master-data/national-holiday/delete-national-holiday-form/page'
import EditBpjsForm from '@/components/(settings)/master-data/bpjs-type/edit-bpjs-type-form/page'
import DetailBpjsTypeForm from '@/components/(settings)/master-data/bpjs-type/detail-bpjs-type-form/page'
import DeleteBpjsTypeForm from '@/components/(settings)/master-data/bpjs-type/delete-bpjs-type-form/page'
import AddInsuranceTypeForm from '@/components/(settings)/master-data/insurance-type/add-insurance-type-form/page'
import EditInsuranceTypeForm from '@/components/(settings)/master-data/insurance-type/edit-insurance-type-form/page'
import DetailInsuranceTypeForm from '@/components/(settings)/master-data/insurance-type/detail-insurance-type-form/page'
import DeleteInsuranceTypeForm from '@/components/(settings)/master-data/insurance-type/delete-insurance-type-form/page'
import BPJSType from '@/components/(settings)/master-data/bpjs-type/bpjs-type-table/page'
import DetailVaccineTypeForm from '@/components/(settings)/master-data/vaccine-status/detail-vaccine-status-form/page'
import DeleteVaccineTypeForm from '@/components/(settings)/master-data/vaccine-status/delete-vaccine-status-form/page'
import InsuranceType from '@/components/(settings)/master-data/insurance-type/insurance-type-table/page'
import VaccineStatusType from '@/components/(settings)/master-data/vaccine-status/vaccine-status-table/page'
import AddBpjsTypeForm from '@/components/(settings)/master-data/bpjs-type/add-bpjs-type-form/page'
import AddVaccineStatusForm from '@/components/(settings)/master-data/vaccine-status/add-vaccine-status-form/page'
import EditVaccineStatusForm from '@/components/(settings)/master-data/vaccine-status/edit-vaccine-status-form/page'
import AddOvertimeTypeForm from '@/components/(settings)/master-data/overtime-type/add-overtime-type-form/page'
import EditOvertimeTypeForm from '@/components/(settings)/master-data/overtime-type/edit-overtime-type-form/page'
import DetailOvertimeTypeForm from '@/components/(settings)/master-data/overtime-type/detail-overtime-type-form/page'
import DeleteOvertimeTypeForm from '@/components/(settings)/master-data/overtime-type/delete-overtime-type-form/page'
import OvertimeTable from '@/components/(settings)/master-data/overtime-type/overtime-type-table/page'
