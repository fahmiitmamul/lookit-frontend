...
import AreaTable from '@/components/(settings)/company/area-table/page'
import BranchTable from '@/components/(settings)/company/branch-table/page'
import DivisionTable from '@/components/(settings)/company/division-table/page'
import PositionTable from '@/components/(settings)/company/position-of-work-table/page'
import LevelTable from '@/components/(settings)/company/job-level-table/page'
import AddCompanyForm from '@/components/(settings)/company/add-company-form/page'
import EditCompanyForm from '@/components/(settings)/company/edit-company-form/page'
import DeleteCompanyForm from '@/components/(settings)/company/delete-company-form/page'
import AddAreaForm from '@/components/(settings)/company/add-area-form/page'
import EditAreaForm from '@/components/(settings)/company/edit-area-form/page'
import DeleteAreaForm from '@/components/(settings)/company/delete-area-form/page'
import AddBranchForm from '@/components/(settings)/company/add-branch-form/page'
import EditBranchForm from '@/components/(settings)/company/edit-branch-form/page'
import DeleteBranchForm from '@/components/(settings)/company/delete-branch-form/page'
import AddDivisionForm from '@/components/(settings)/company/add-division-form/page'
import EditDivisionForm from '@/components/(settings)/company/edit-division-form/page'
import DetailDivisionForm from '@/components/(settings)/company/detail-division-form/page'
import DeleteDivisionForm from '@/components/(settings)/company/delete-division-form/page'
import AddPositionForm from '@/components/(settings)/company/add-position-of-work-form/page'
import EditPositionForm from '@/components/(settings)/company/edit-position-of-work-form/page'
import DetailPositionForm from '@/components/(settings)/company/detail-position-of-work-form/page'
import DeletePositionForm from '@/components/(settings)/company/delete-position-of-work-form/page'
import EditLevelForm from '@/components/(settings)/company/edit-level-form/page'
import DetailLevelForm from '@/components/(settings)/company/detail-level-form/page'
import DeleteLevelForm from '@/components/(settings)/company/delete-level-form/page'
import AddLevelForm from '@/components/(settings)/company/add-job-level-form/page'
import DetailCompanyForm from '@/components/(settings)/company/detail-company-form/page'
import DetailAreaForm from '@/components/(settings)/company/detail-area-form/page'
import DetailBranchForm from '@/components/(settings)/company/detail-branch-form/page'
