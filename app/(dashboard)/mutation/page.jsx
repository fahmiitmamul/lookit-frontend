...
import PositionMutationTable from '@/components/mutasi/tabel-mutasi-jabatan/page'
import LocationMutationTable from '@/components/mutasi/tabel-mutasi-lokasi/page'
import AddLocationMutation from '@/components/mutasi/form-tambah-mutasi-lokasi/page'
import EditLocationMutation from '@/components/mutasi/form-edit-mutasi-lokasi/page'
import DeleteLocationMutation from '@/components/mutasi/form-hapus-mutasi-lokasi/page'
import DetailMutationPositionForm from '@/components/mutasi/form-detail-mutasi-jabatan/page'
import DetailMutationLocationForm from '@/components/mutasi/form-detail-mutasi-lokasi/page'
import AddMutationPositionForm from '@/components/mutasi/form-tambah-mutasi-jabatan/page'
import EditMutationPositionForm from '@/components/mutasi/form-edit-mutasi-jabatan/page'
import DeleteMutationPositionForm from '@/components/mutasi/form-hapus-mutasi-jabatan/page'
import Dropdown from '@/components/ui/Dropdown'
import { useSelector } from 'react-redux'
import { toast } from 'react-toastify'
import { PDFDownloadLink } from '@react-pdf/renderer'
import MutationDocument from '@/components/mutasi/download-pdf-mutasi/page'
import DownloadMutation from '@/components/mutasi/download-modal/page'

export default function Mutasi() {
    const [showDownloadMutationModal, setShowDownloadMutationModal] =
        useState(false)
        ...
        <>
            <div>
                <div className="w-full flex flex-wrap justify-between mb-5">
                    <div className="flex flex-wrap gap-5">
                        <div className="flex justify-center items-center">
                            <h5>Data Mutasi {selectedItem}</h5>
                        </div>
                    </div>
                            ...
                            <Button
                                ...
                                onClick={() => {
                                    selectedMutationData?.length == 0
                                        ...
                                        : setShowDownloadMutationModal(
                                              !showDownloadMutationModal
                                          )
                                }}
                            />
                        </div>
                ...
                <Modal
                    ...
                    labelClass="btn-outline-dark"
                    className="max-w-sm"
                    activeModal={showDownloadMutationModal}
                    onClose={() => {
                        setShowDownloadMutationModal(!showDownloadMutationModal)
                    }}
                >
                    <DownloadMutation
                        selectedMutationData={selectedMutationData}
                        isClient={isClient}
                    />
                </Modal>
            </div>
