'use client'
import DetailCostForm from '@/components/(keuangan)/biaya/form-detail-biaya/page'
import EditCostForm from '@/components/(keuangan)/biaya/form-edit-biaya/page'
import DeleteCostForm from '@/components/(keuangan)/biaya/form-hapus-biaya/page'
import AddCostForm from '@/components/(keuangan)/biaya/form-tambah-biaya/page'
import Cost from '@/components/(keuangan)/biaya/tabel-biaya/page'
...
import DownloadCostModal from '@/components/(keuangan)/biaya/download-modal/page'
