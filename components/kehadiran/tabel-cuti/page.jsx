...
export default function LeaveTypeTable({
    ...
    const toggleSelectAll = () => {
        ...
        setSelectedRows(selectAll ? [] : leaveData?.data || [])
        dispatch(
            setSelectedPresenceData(selectAll ? [] : leaveData?.data || [])
        )
    }
    ...
    const toggleSelectIndividual = (row) => {
        ...
        setSelectAll(updatedSelectedRows.length === leaveData?.data?.length)
