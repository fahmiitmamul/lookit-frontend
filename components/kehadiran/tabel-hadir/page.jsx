...
export default function PresentTable({
    ...
    const toggleSelectAll = () => {
        ...
        setSelectedRows(selectAll ? [] : presentData?.data || [])
        dispatch(
            setSelectedPresenceData(selectAll ? [] : presentData?.data || [])
        )
    }
    ...
    const toggleSelectIndividual = (row) => {
        ...
        setSelectAll(updatedSelectedRows.length === presentData?.data?.length)
