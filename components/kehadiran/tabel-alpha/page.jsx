...
export default function AlphaTable({
    ...
    const toggleSelectAll = () => {
        ...
        setSelectedRows(selectAll ? [] : alphaData?.data || [])
        dispatch(
            setSelectedPresenceData(selectAll ? [] : alphaData?.data || [])
        )
    }
    ...
    const toggleSelectIndividual = (row) => {
        ...
        setSelectAll(updatedSelectedRows.length === alphaData?.data?.length)
