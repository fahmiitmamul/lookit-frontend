...
export default function FinishedTasksForm({
    ...
    const toggleSelectAll = () => {
        ...
        setSelectedRows(selectAll ? [] : finishedTasksData?.data || [])
        dispatch(
            setSelectedTasksData(selectAll ? [] : finishedTasksData?.data || [])
        )
    }
    ...
    const toggleSelectIndividual = (row) => {
        ...
        setSelectAll(
            updatedSelectedRows.length === finishedTasksData?.data?.length
        )
                        ...
                        <div className="overflow-hidden ">
                            <table className="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                                ...
                                <tbody className="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                    {finishedTasksData?.data?.map((row, i) => (
                                        <tr
                                            key={i}
                            ...
                            {finishedTasksData?.data?.length === 0 && (
