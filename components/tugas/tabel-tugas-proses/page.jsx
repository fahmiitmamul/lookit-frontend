...
export default function ProcessedTasks({
    ...
    const toggleSelectAll = () => {
        ...
        setSelectedRows(selectAll ? [] : processedTasksData?.data || [])
        dispatch(
            setSelectedTasksData(
                selectAll ? [] : processedTasksData?.data || []
            )
        )
    }
    ...
    const toggleSelectIndividual = (row) => {
        ...
        setSelectAll(
            updatedSelectedRows.length === processedTasksData?.data?.length
        )
                        ...
                        <div className="overflow-hidden ">
                            <table className="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                                ...
                                <tbody className="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                    {processedTasksData?.data?.map((row, i) => (
                                        <tr
                                            key={i}
                            ...
                            {processedTasksData?.data?.length === 0 && (
