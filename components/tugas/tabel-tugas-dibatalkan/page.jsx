...
export default function CanceledTasks({
    ...
    const toggleSelectAll = () => {
        ...
        setSelectedRows(selectAll ? [] : canceledTasksData?.data || [])
        dispatch(
            setSelectedTasksData(selectAll ? [] : canceledTasksData?.data || [])
        )
    }
    ...
    const toggleSelectIndividual = (row) => {
        ...
        setSelectAll(
            updatedSelectedRows.length === canceledTasksData?.data?.length
        )
                        ...
                        <div className="overflow-hidden ">
                            <table className="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                                ...
                                <tbody className="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                    {canceledTasksData?.data?.map((row, i) => (
                                        <tr
                                            key={i}
                            ...
                            {canceledTasksData?.data?.length === 0 && (
