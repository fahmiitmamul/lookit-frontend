...
const AddMutationPositionForm = ({ showAddMutationPositionModal }) => {
    ...
    const postMutation = useMutation({
        mutationFn: async (values) => {
            ...
            return http(token).post(`/mutation/create-position`, form)
        },
        onSuccess: () => {
    ...
    const onSubmit = (data) => {
        showAddMutationPositionModal(false)
...
export default AddMutationPositionForm
