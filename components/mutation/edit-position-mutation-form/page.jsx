...
const EditMutationPositionForm = ({ showEditMutationPositionModal }) => {
    ...
    const onSubmit = (data) => {
        showEditMutationPositionModal(false)
...
export default EditMutationPositionForm
