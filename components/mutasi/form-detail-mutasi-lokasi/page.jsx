...
const DetailMutationLocationForm = ({ showViewMutationLocationModal }) => {
    ...
    const {
        ...
        defaultValues: async () => {
            ...
            const transformedData = {
                ...data.results,
                area_id: parseInt(data.results.last_area_id),
            }
    ...
    const onSubmit = (data) => {
        showViewMutationLocationModal(false)
...
export default DetailMutationLocationForm
