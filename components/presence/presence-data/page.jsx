...
import PresentTable from '../present-table/page'
import ArrivingLate from '../arriving-late-table/page'
import GoHomeEarly from '../go-home-early-table/page'
import NotAbsentFromHome from '../not-absent-from-home-table/page'
import AlphaTable from '../alpha-table/page'
import SickTable from '../sick-table/page'
import PermissionTable from '../permission-table/page'
import LeaveTypeTable from '../leave-table/page'
import HolidayTable from '../holiday-table/page'
