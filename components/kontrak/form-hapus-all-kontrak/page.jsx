...
const DeleteAllContractForm = ({ showDeleteAllContractModal }) => {
    ...
    const handleDelete = useMutation({
        ...
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['all-contract'] })
    ...
    const onSubmit = (data) => {
        showDeleteAllContractModal(false)
        handleDelete.mutate()
...
export default DeleteAllContractForm
