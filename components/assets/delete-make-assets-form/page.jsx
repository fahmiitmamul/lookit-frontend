...
const DeleteMakeAssetsForm = ({ setShowDeleteMakeAssetsModal }) => {
    ...
    const handleDelete = useMutation({
        mutationFn: async () => {
            return http(token).delete(`/assets/${assetId}`)
        },
        onSuccess: () => {
    ...
    const onSubmit = (data) => {
        setShowDeleteMakeAssetsModal(false)
        handleDelete.mutate()
...
export default DeleteMakeAssetsForm
