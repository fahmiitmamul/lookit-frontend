...
const EditPendingRequestForm = ({ setShowEditPendingRequestModal }) => {
    ...
    const editPendingRequest = useMutation({
        ...
        onSuccess: () => {
            ...
            setShowEditPendingRequestModal(false)
    ...
    const onSubmit = (values) => {
        ...
        editPendingRequest.mutate(values)
    }

    const editPendingRequestSchema = yup.object({
    ...
    const {
        ...
        resolver: yupResolver(editPendingRequestSchema),
        mode: 'all',
    })
...
export default EditPendingRequestForm
