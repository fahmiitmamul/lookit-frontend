...
const StatusAllContractForm = ({ showStatusAllContractModal }) => {
    ...
    const postContract = useMutation({
        ...
        onSuccess: () => {
            ...
            showStatusAllContractModal(!showStatusAllContractModal)
        },
        onError: (err) => {
            ...
            >
                ...
                <div className="flex gap-5 justify-end">
                    <Button
                        ...
                        type="button"
                        onClick={() => {
                            showStatusAllContractModal(false)
                        }}
                    />
                    <Button
                        text="Kirim"
...
export default StatusAllContractForm
