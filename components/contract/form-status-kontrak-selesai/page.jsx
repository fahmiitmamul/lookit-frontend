...
const StatusFinishedContractForm = ({ showStatusFinishedContractModal }) => {
    ...
    const postContract = useMutation({
        ...
        onSuccess: () => {
            ...
            showStatusFinishedContractModal(!showStatusFinishedContractModal)
        },
        onError: (err) => {
            ...
            >
                ...
                <div className="flex gap-5 justify-end">
                    <Button
                        ...
                        type="button"
                        onClick={() => {
                            showStatusFinishedContractModal(false)
                        }}
                    />
                    <Button
                        text="Kirim"
...
export default StatusFinishedContractForm
