...
const StatusProcessedContractForm = ({ showStatusProcessedContractModal }) => {
    ...
    const postContract = useMutation({
        ...
        onSuccess: () => {
            ...
            showStatusProcessedContractModal(!showStatusProcessedContractModal)
        },
        onError: (err) => {
    ...
    useEffect(() => {
        async function getDocusealToken() {
            const { data } = await http().get(`/docuseal-token?data=${file}`)
            setJwt(data.results)
            return data.results
        }
            ...
            >
                ...
                <div className="flex gap-5 justify-end">
                    <Button
                        ...
                        type="button"
                        onClick={() => {
                            showStatusProcessedContractModal(false)
                        }}
                    />
                    <Button
                        text="Kirim"
...
export default StatusProcessedContractForm
