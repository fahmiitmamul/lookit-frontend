...
export default function DeclinedOvertimeTable({
    ...
    const toggleSelectAll = () => {
        ...
        setSelectedRows(selectAll ? [] : declinedOvertimeData?.data || [])
        dispatch(
            setSelectedOvertimeData(
                selectAll ? [] : declinedOvertimeData?.data || []
            )
        )
    }
    ...
    const toggleSelectIndividual = (row) => {
        ...
        setSelectAll(
            updatedSelectedRows.length === declinedOvertimeData?.data?.length
        )
                ...
                <SimpleBar className="overflow-auto w-full bg-white dark:bg-slate-700 text-slate-800 dark:text-slate-400 rounded-md">
                    <div className="inline-block min-w-full align-middle">
                        <div className="overflow-hidden ">
                            ...
                            {declinedOvertimeData?.data?.length === 0 && (
