...
const EditCompanyForm = ({ showEditCompanyModal }) => {
    ...
    const editCompany = useMutation({
        mutationFn: async (values) => {
            ...
            return http(token).patch(`/company/${companyId}`, form)
        },
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['company'] })
            dispatch(setLoading(false))
            toast.success('Berhasil mengedit perusahaan')
                ...
                <div className="lg:grid-cols-2 grid gap-5 grid-cols-1">
                    <div>
                        ...
                        <Fileinput
                            ...
                            id="profile-photo"
                            className={
                                errors?.logo && 'border-danger-500 border'
                            }
                        />
                        {errors?.logo?.message && (
                            <div
