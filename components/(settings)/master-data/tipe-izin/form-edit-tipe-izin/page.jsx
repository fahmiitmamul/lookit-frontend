...
const EditPermissionType = ({ showEditPermissionTypeModal }) => {
    ...
    const postLeaveType = useMutation({
        mutationFn: async (values) => {
            ...
            return http(token).patch(`/permission-type/${permissionId}`, data)
        },
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['permission-type'] })
            dispatch(setLoading(false))
            showEditPermissionTypeModal(false)
...
export default EditPermissionType
