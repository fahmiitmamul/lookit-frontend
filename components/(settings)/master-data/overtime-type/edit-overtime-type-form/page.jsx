...
const EditOvertimeTypeForm = ({ setShowEditOvertimeTypeModal }) => {
    ...
    const postOvertimeType = useMutation({
        mutationFn: async (values) => {
            ...
            return http(token).patch(`/overtime-type/${overtimeTypeId}`, data)
        },
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['overtime-type'] })
            dispatch(setLoading(false))
            setShowEditOvertimeTypeModal(false)
            toast.success('Berhasil mengedit lembur')
        },
        onError: (err) => {
...
export default EditOvertimeTypeForm
