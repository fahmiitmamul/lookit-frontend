...
const DeleteBpjsTypeForm = ({ setShowDeleteBpjsTypeModal }) => {
    ...
    const handleDelete = useMutation({
        mutationFn: async () => {
            return http(token).delete(`/bpjs/${bpjsId}`)
        },
        onSuccess: () => {
    ...
    const onSubmit = () => {
        setShowDeleteBpjsTypeModal(false)
        handleDelete.mutate()
...
export default DeleteBpjsTypeForm
