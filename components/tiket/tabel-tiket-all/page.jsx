...
export default function AllTicketTable({
    showEditAllTicket,
    showViewAllTicket,
    showDeleteAllTicket,
    allTicketData,
    ...
    const toggleSelectAll = () => {
        ...
        setSelectedRows(selectAll ? [] : allTicketData?.data || [])
        dispatch(setSelectedTicket(selectAll ? [] : allTicketData?.data || []))
    }
    ...
    const toggleSelectIndividual = (row) => {
        ...
        setSelectAll(updatedSelectedRows.length === allTicketData?.data?.length)
