...
const EditMasterGajiPotonganForm = ({ showEditMasterGajiPotonganModal }) => {
    ...
    const masterGajiPotonganId = useSelector(
    ...
    const {
        ...
        defaultValues: async () => {
            const { data } = await http(token).get(
                `/master-salary-deduction/${masterGajiPotonganId}`
            )
            return data.results
        },
    ...
    const patchMasterSalaryDeduction = useMutation({
        ...
        onSuccess: () => {
            ...
            showEditMasterGajiPotonganModal(false)
            toast.success('Berhasil mengedit master gaji potongan')
        },
        onError: (err) => {
    ...
    const onSubmit = (data) => {
        ...
        patchMasterSalaryDeduction.mutate(data)
    }
...
export default EditMasterGajiPotonganForm
