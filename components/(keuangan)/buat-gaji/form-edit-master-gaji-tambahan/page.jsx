...
const EditMasterGajiTambahanForm = ({ showEditMasterGajiTambahanModal }) => {
    ...
    const postMasterSalary = useMutation({
        ...
        onSuccess: () => {
            ...
            showEditMasterGajiTambahanModal(false)
            toast.success('Berhasil mengedit master gaji tambahan')
        },
        onError: (err) => {
...
export default EditMasterGajiTambahanForm
