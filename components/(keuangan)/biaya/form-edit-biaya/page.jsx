...
const EditCostForm = ({ setShowEditCostModal }) => {
    ...
    const costId = useSelector((state) => state.finance.finance.selectedCostId)
    ...
    const patchCost = useMutation({
        mutationFn: async (values) => {
            ...
            return http(token).patch(`/cost/${costId}`, form)
        },
        onSuccess: () => {
