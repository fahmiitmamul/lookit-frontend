...
const IncomingGuaranteeDocument = ({ data }) => (
    <Document>
        <Page size="A4" style={styles.page}>
            ...
            <View style={styles.table}>
                <View style={styles.row}>
                    ...
                    <Text style={styles.headerCell}>Tanggal Masuk</Text>
                ...
                {data?.map((row, index) => (
                    <View style={styles.row} key={row.id}>
                        ...
                        <Text style={styles.cell}>{row?.start_date}</Text>
...
export default IncomingGuaranteeDocument
