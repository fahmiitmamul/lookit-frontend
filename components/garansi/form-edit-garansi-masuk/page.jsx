...
const EditIncomingGuaranteeForm = ({ setShowEditIncomingGuaranteeModal }) => {
    ...
    const patchIncomingGuarantee = useMutation({
        mutationFn: async (values) => {
            ...
            return http(token).patch(`/incoming-guarantee/${guaranteeId}`, form)
        },
        onSuccess: () => {
    ...
    const onSubmit = (data) => {
        setShowEditIncomingGuaranteeModal(false)
...
export default EditIncomingGuaranteeForm
