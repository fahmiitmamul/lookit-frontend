...
const EditApprovedRequestForm = ({ setShowEditApprovedRequestModal }) => {
    ...
    const editApprovedRequests = useMutation({
        ...
        onSuccess: () => {
            ...
            setShowEditApprovedRequestModal(false)
    ...
    const onSubmit = (values) => {
        ...
        editApprovedRequests.mutate(values)
    }

    const editApprovedRequestsSchema = yup.object({
    ...
    const {
        ...
        resolver: yupResolver(editApprovedRequestsSchema),
        mode: 'all',
    })
...
export default EditApprovedRequestForm
