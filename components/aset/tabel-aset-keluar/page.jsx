...
export default function OutgoingAssetsTable({
    ...
    const toggleSelectAll = () => {
        ...
        setSelectedRows(selectAll ? [] : outgoingAssetsData?.data || [])
        dispatch(
            setSelectedAssets(selectAll ? [] : outgoingAssetsData?.data || [])
        )
    }
    ...
    const toggleSelectIndividual = (row) => {
        ...
        setSelectAll(
            updatedSelectedRows.length === outgoingAssetsData?.data?.length
        )
                        ...
                        <div className="overflow-hidden ">
                            <table className="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                                ...
                                <tbody className="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                    {outgoingAssetsData?.data?.map((row, i) => (
                                        <tr
                                            key={i}
                            ...
                            {outgoingAssetsData?.data?.length === 0 && (
