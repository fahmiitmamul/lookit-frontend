...
const EditOutgoingAssetsForm = ({ setShowEditOutgoingAssetsModal }) => {
    ...
    const patchOutgoingAssets = useMutation({
        mutationFn: async (values) => {
            ...
            return http(token).patch(`/outgoing-assets/${assetId}`, form)
        },
        onSuccess: () => {
    ...
    const onSubmit = (data) => {
        setShowEditOutgoingAssetsModal(false)
        patchOutgoingAssets.mutate(data)
...
export default EditOutgoingAssetsForm
