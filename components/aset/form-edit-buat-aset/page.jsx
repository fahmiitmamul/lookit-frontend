...
const EditMakeAssetsForm = ({ setShowEditAssetsModal }) => {
    ...
    const patchAssets = useMutation({
        mutationFn: async (values) => {
            ...
            return http(token).patch(`/assets/${assetId}`, form)
        },
        onSuccess: () => {
            ...
            toast.success('Berhasil mengedit inventaris')
        },
        onError: (err) => {
    ...
    const onSubmit = (data) => {
        setShowEditAssetsModal(false)
        patchAssets.mutate(data)
                            ...
                            <Controller
                                ...
                                render={({
                                    ...
                                    <Fileinput
                                        {...fieldProps}
                                        name="picture"
                                        placeholder={assetsData?.picture}
                                        className={
...
export default EditMakeAssetsForm
