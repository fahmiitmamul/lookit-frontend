...
const EditGuaranteeForm = ({ setShowEditGuaranteeModal }) => {
    ...
    const onSubmit = (data) => {
        setShowEditGuaranteeModal(false)
                            ...
                            <Controller
                                ...
                                render={({
                                    ...
                                    <Fileinput
                                        ...
                                        placeholder={guaranteeData.file}
...
export default EditGuaranteeForm
