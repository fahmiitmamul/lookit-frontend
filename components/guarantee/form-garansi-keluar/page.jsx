...
const AddOutgoingGuaranteeForm = ({ setShowAddOutgoingGuaranteeModal }) => {
    ...
    const postOutgoingGuarantee = useMutation({
        mutationFn: async (values) => {
            ...
            return http(token).post(`/outgoing-guarantee`, form)
        },
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['outgoing-guarantee'] })
            dispatch(setLoading(false))
            toast.success('Berhasil menambah garansi keluar')
        },
        onError: (err) => {
    ...
    const onSubmit = (data) => {
        setShowAddOutgoingGuaranteeModal(false)
        postOutgoingGuarantee.mutate(data)
...
export default AddOutgoingGuaranteeForm
