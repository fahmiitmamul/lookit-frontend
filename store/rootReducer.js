...
import employeeReducer from '@/components/(karyawan)/store'
...
import tasksReducer from '@/components/tugas/store'
...
import financeReducer from '@/components/(keuangan)/store'
